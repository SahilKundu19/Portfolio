        ...
        <>
          ...
          >
            <Card className="w-full max-w-7xl max-h-[90vh] overflow-hidden bg-card/95 backdrop-blur-xl border shadow-2xl">
              ...
              <div
                ref={scrollRef}
                className="overflow-y-auto max-h-[calc(90vh-320px)] md:max-h-[calc(90vh-320px)]"
              >
                <div className="p-6 md:p-8 space-y-12">
                    ...
                    >
                      ...
                      <div className="space-y-8">
                        ...
                        {project.process.wireframes &&
                          project.process.wireframes.length > 0 && (
                            <div>
                              <h3 className="text-xl mb-4 font-semibold">
                                Design & Wireframes
                              </h3>
                              <div className="grid md:grid-cols-2 gap-4">
                                {project.process.wireframes.map(
                                  (wireframe, index) => (
                                    <motion.div
                                      key={index}
                        ...
                        {project.process.development &&
                          project.process.development.length > 0 && (
                            <div>
                              ...
                              <div className="space-y-3">
                                {project.process.development.map(
                                  (step, index) => (
                                    <motion.div
                                      key={index}
                        ...
                        {project.process.challenges &&
                          project.process.challenges.length > 0 && (
                            <div>
                              <h3 className="text-xl mb-4 font-semibold">
                                Challenges & Solutions
                              </h3>
                              <div className="space-y-4">
                                {project.process.challenges.map(
                                  (item, index) => (
                                    <MotionCard
                                      key={index}
                                      className="p-4"
                  ...
                  >
                    ...
                    <p className="text-lg text-muted-foreground mb-6 max-w-2xl mx-auto">
                      Explore my other work to see how I solve complex problems
